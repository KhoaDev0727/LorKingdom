...
public class ResendVerificationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String subject = "Login Verification Code - LorKingdom";
        ...
        String body = "<html>"
                ...
                + "</div>"
                + "<p>Dear " + username + ",</p>"
                + "<p>You requested a new verification code to log into your account at LorKingdom. Please use the verification code below to complete your login process:</p>"
