                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="w-full lg:w-1/4 p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <ul>
                                <li>
                                    <input class="mr-2" id="option1" type="checkbox" />
                                    <label for="option1">
                                        Phương tiện giao thông
                                    </label>
                                </li>
                                <li>
                                    <input class="mr-2" id="option2" type="checkbox" />
                                    <label for="option2">
                                        Kéo đồ chơi
                                    </label>
                                </li>
                                <li>
                                    <input class="mr-2" id="option3" type="checkbox" />
                                    <label for="option3">
                                        Đồ chơi giáo dục
                                    </label>
                                </li>
                                <li>
                                    <input class="mr-2" id="option4" type="checkbox" />
                                    <label for="option4">
                                        Đồ chơi sáng tạo
                                    </label>
                                </li>
                                <li>
                                    <input class="mr-2" id="option5" type="checkbox" />
                                    <label for="option5">
                                        Đồ chơi động vật
                                    </label>
                                </li>
                                <li>
                                    <input class="mr-2" id="option6" type="checkbox" />
                                    <label for="option6">
                                        Búp bê
                                    </label>
                                </li>
                        ...
                        <div class="mb-4">
                            ...
                            <ul>
                                <li>
                                    <input class="mr-2" id="age1" type="checkbox" />
                                    <label for="age1">
                                        12 tuổi trở lên
                                    </label>
                                </li>
                                <li>
                                    <input class="mr-2" id="age2" type="checkbox" />
                                    <label for="age2">
                                        6-11 tuổi
                                    </label>
                                </li>
                                <li>
                                    <input class="mr-2" id="age3" type="checkbox" />
                                    <label for="age3">
                                        3-5 tuổi
                                    </label>
                                </li>
                                <li>
                                    <input class="mr-2" id="age4" type="checkbox" />
                                    <label for="age4">
                                        0-2 tuổi
                                    </label>
                                </li>
