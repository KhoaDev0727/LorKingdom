...
<html lang="en">
    <head>
        ...
        <title>Trang xác minh email</title>
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
        <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500&display=swap" rel="stylesheet">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">
        <link rel="stylesheet" href="./assets/styleUser/styleVerifyCode.css"/>
    </head>
    <body>
        <div class="verify-container">
            ...
            <form action="VerifyCodeServlet" method="POST">
                <div class="mb-3 text-start">
                    ...
                    <input type="text" class="form-control" id="code" name="code" placeholder="Nhập mã xác minh" required>
                    <% 
            ...
            <div class="mt-3">
                <button class="btn btn-secondary w-100" onclick="location.href = 'login.jsp'">Quay lại Đăng nhập</button>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="login.jsp" class="btn btn-primary">Đi đến Đăng nhập</a>
                    </div>
                </div>
            </div>
        </div>
